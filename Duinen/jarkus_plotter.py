...
excel = r"C:\Users\vince\Dropbox\Wolfwater\HHNK\plots\jrk_13_3.xlsx"
adds = r"C:\Users\vince\Dropbox\Wolfwater\HHNK\plots\invoegen_13_3.xlsx"

outpath = "C:/Users/vince/Desktop/plots_13_2/hoofdraaien"
...
def plotter():
    ...
    for name, group in grouped:
        ...
        for key, grp in group.groupby(['jaar']):
            ...
            if sleutel in jaartallen:
                if sleutel == jaar:
                    ...
                    if int(name) in raaien:
                        ax.plot(x, y, linewidth = 1, label = sleutel)
        ...
        profiel = int(name)
        ax.set_title('JARKUS-raai '+str(profiel)+' (2003 t/m 2017)')
        ...
        leg.set_title('JARKUS-raai', prop={'size': 12, 'weight': 'heavy'})
        ...
        # plt.show()
        plt.savefig(path.join(outpath, "raai_{0}.png".format(profiel)), pad_inches=0.02, dpi=300, bbox_inches='tight')
        plt.close()


        del fig, ax, xmax, xmin
