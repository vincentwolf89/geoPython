...
arcpy.env.workspace = r'D:\Projecten\HDSR\data\oplevering_hdsr.gdb'
...
excelmap = 'D:/Projecten/HDSR/oplevering/xlsx_uitvoer/'
totaal_profielen = []
with arcpy.da.SearchCursor(trajecten,['SHAPE@',code_hdsr]) as cursor:
    for row in cursor:
        ...
        bereken_restlevensduur(profielen,bodemdalingskaart)
        print profielen
